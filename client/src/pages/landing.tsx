    ...
    >
      ...
      <section className="relative bg-[#F6F3F9] py-8 overflow-hidden">
        <div className="flex justify-center mb-8 relative z-20">
          <p className="font-display text-3xl font-normal text-[#2e1a47]">
            Support for dozens of brands
          </p>
        </div>
        <div
          className="absolute left-0 top-0 h-full z-10 pointer-events-none"
          style={{ width: '400px', background: 'linear-gradient(to right, #F6F3F9 0%, #F6F3F9 80%, transparent 100%)' }}
        />
        <div
          className="absolute right-0 top-0 h-full z-10 pointer-events-none"
          style={{ width: '400px', background: 'linear-gradient(to left, #F6F3F9 0%, #F6F3F9 80%, transparent 100%)' }}
        />
